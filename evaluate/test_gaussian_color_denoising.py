...
from models.basicsr.models.archs.38_HNNFormer import HNNFormer
from models.basicsr.models.archs.38_HNNFormer
...
model_restoration = HNNFormer(**opt)    
...
if sigma == 15:
    ...
    weights = 'model_zoo/team38_HNNFormer.pth'
